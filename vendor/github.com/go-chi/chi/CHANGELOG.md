...
- Major update to chi library with many exciting updates, but also some _breaking changes_
...
- _NOTE:_ please update your import paths to `"github.com/go-chi/chi"`
- _NOTE:_ chi v2 is still available at https://github.com/go-chi/chi/tree/v2
