...
"""Command for listing recoverable snapshots."""
...
class List(base.ListCommand):
  ...
  def _Run(self, args):
    ...
    list_implementation = lister.GlobalLister(
        client, client.apitools_client.recoverableSnapshots
    )

    return lister.Invoke(request_data, list_implementation)


List.detailed_help = base_classes.GetGlobalListerHelp('recoverable snapshots')
