...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.iam.v1.iam_policy_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SETIAMPOLICYREQUEST.fields_by_name['resource']._serialized_options = b'\340A\002\372A\003\n\001*'
  ...
  _GETIAMPOLICYREQUEST.fields_by_name['resource']._serialized_options = b'\340A\002\372A\003\n\001*'
  _TESTIAMPERMISSIONSREQUEST.fields_by_name['resource']._options = None
  _TESTIAMPERMISSIONSREQUEST.fields_by_name['resource']._serialized_options = b'\340A\002\372A\003\n\001*'
  _TESTIAMPERMISSIONSREQUEST.fields_by_name['permissions']._options = None
  _TESTIAMPERMISSIONSREQUEST.fields_by_name['permissions']._serialized_options = b'\340A\002'
